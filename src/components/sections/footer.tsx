			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				<div className="grid grid-cols-1 md:grid-cols-3 items-center gap-10">
					<div className="text-center md:text-left space-y-1">
						<p className="text-xl font-black font-mono uppercase text-gray-200 tracking-tighter leading-none">
							KOMMITRAX
						</p>
						<p className="text-sm font-mono">
							Running on{" "}
							<span className="text-green-200 font-bold">Sepolia Testnet</span>
						</p>
					</div>

					<div className="text-center flex flex-col items-center">
						<p className="text-xs text-gray-400 max-w-70 leading-relaxed italic">
